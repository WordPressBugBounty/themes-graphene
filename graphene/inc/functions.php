...
function graphene_grid_width( $mod = '', $grid_one = 1, $grid_two = '', $grid_three = '', $post_id = NULL ){
	...
	/* Ensure $grid_two and $grid_three are numbers */
	if ( ! is_numeric( $grid_two ) ) $grid_two = 8;
	if ( ! is_numeric( $grid_three ) ) $grid_three = 6;
...
function graphene_get_image_size( $file ){
	...
	$file = str_replace( $uploads_path['baseurl'], $uploads_path['basedir'], $file );
